...
const countryCodes = [{ "code": "AD", "name": "Andorra" },
  ...
  testSubmit = (city, country) =>  {
  console.log(city + country)
  //will push the cities.filter logic into a lambda and then use axios to post to the URL and get back lat and lon as a response
