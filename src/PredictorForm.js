...
const content = (
  <>
    <Paragraph>
      The COVID-19 Predictor asks you a series of questions and depending on
      your answers makes a prediction based on sample data of what is the
      maximum risk of hopitilization.
    </Paragraph>
    <Paragraph>
...
export default class PredictorForm extends Component {
  ...
  onChange = (value) => {
    if (value.length > 0) {
      ...
      this.setState({
        prediction: predictObject.predict,
        sampleSize: predictObject.sample,
        percentageAdmissions: predictObject.admission,
        stageName: 'Prediction Complete',
      });
    } else {
      this.setState({
        prediction: '',
        ...
        >
          ...
          <Form className="cascader-form-wrapper">
            <Cascader
              ...
              placeholder="Please select to start"
            />
          </Form>
          <br />
          <Descriptions title="Prediction Information">
            ...
            <Descriptions.Item label="Admissions %">
              {percentageAdmissions}
            </Descriptions.Item>
          </Descriptions>
        </PageHeader>
